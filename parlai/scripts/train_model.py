...
class TrainLoop:
    ...
    def train(self):
                ...
                if (
                    ...
                    if opt.get('run_test_after_validation', False):
                        ...
                        if self.test_worlds is None:
                            # we need to load the world now
                            self.test_worlds = _maybe_load_eval_worlds(self.agent, test_opt, 'test')
        ...
        if os.path.isfile(last_model):
            ...
            valid_worlds = _maybe_load_eval_worlds(last_agent, last_model_opt, 'valid')
            ...
            test_worlds = _maybe_load_eval_worlds(last_agent, last_model_opt, 'test')
